...
export default function ProfilePage() {
  ...
  return (
    <div className="w-full h-screen overflow-y-auto">
      <div className="max-w-6xl mx-auto p-3 md:p-4 pt-16 md:pt-4">
        <Link href="/chat">
          ...
          {currentUser && (
            <>
              <Card className="lg:h-[calc(100vh-8rem)] flex flex-col">
                ...
                <CardContent className="space-y-6 p-3 md:p-6 pt-0 flex-1 flex flex-col justify-between">
                  {/* Avatar */}
                  <div className="space-y-6">
                    ...
                    {/* User Info - Now in 2 columns on larger screens */}
              ...
              {/* Friend Requests and User List Sidebar - Now scrollable */}
