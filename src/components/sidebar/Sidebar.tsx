    ...
    <div className="w-64 border-r border-gray-200 dark:border-gray-700 flex flex-col h-screen bg-white dark:bg-gray-900">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <Input
          ...
          className="bg-gray-100 dark:bg-gray-800 border-0 rounded-lg mb-2"
        />
        <Button 
              ...
              {filteredUsers.length > 0 ? (
                filteredUsers.map((u: any) => (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-sm text-gray-900 dark:text-white mb-1"
                  >
                ...
                <div className="px-3 py-4 text-center text-gray-600 dark:text-gray-400 text-sm">
                  No users found
                </div>
              )}
